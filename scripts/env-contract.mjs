...
function deriveStaging(map, sources = new Map()) {
  ...
  put(map, "AI_ASSISTANT_BASE_URL", "http://ai-assistant:8000/api/v1")
  put(map, "MEDUSA_INTERNAL_URL", "http://medusa-backend:9000")
  sources.set("AI_ASSISTANT_BASE_URL", "derived")
  sources.set("MEDUSA_INTERNAL_URL", "derived")
