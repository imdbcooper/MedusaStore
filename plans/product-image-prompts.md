# Промты для генерации изображений IT-услуг

> Дата: 2026-05-14
> Источник: `plans/product-catalog-plan.md`, раздел C
...
|----------|----------|
| Размер | 1024×1024 |
| Стиль | Isometric / flat professional illustration |
| Палитра | Teal, navy, warm beige/cream, muted neutrals |
| Эстетика | Деловой, корпоративный, минималистичный |
| Текст на изображении | Нет (no text, no logos) |
| Формат файла | PNG |
| Совместимость | Midjourney, DALL-E 3, Stable Diffusion XL |

### Рекомендации по генерации

- Добавляйте `--ar 1:1` для Midjourney
- Для DALL-E 3: используйте промт как есть, укажите размер 1024x1024
- Для Stable Diffusion: добавьте negative prompt: `text, letters, words, watermark, logo, blurry, low quality, photorealistic`
- Все промты оптимизированы под единый визуальный стиль каталога

---

## Категория 1: Разработка сайтов и веб-приложений

### 1. Landing Page под ключ

- **handle:** `landing-page-pod-klyuch`
- **Название:** Landing Page «под ключ» для лидогенерации
...
- **Название:** Корпоративный сайт (B2B/B2C портал)
...
### 3. Интернет-магазин Basic

- **handle:** `internet-magazin-basic`
- **Название:** Интернет-магазин (E-commerce Basic)
...
### 4. E-commerce Enterprise

- **handle:** `ecommerce-enterprise`
- **Название:** E-commerce платформа Enterprise
...
- **Название:** Веб-приложение (SPA / SaaS)
...
- **Название:** Нативные iOS и Android приложения
...
### 7. Кросс-платформенное приложение

- **handle:** `kross-platformennoe-prilozhenie`
- **Название:** Кросс-платформенное приложение (React Native / Flutter)
...
### 8. Публикация и ASO-оптимизация

- **handle:** `publikaciya-aso`
- **Название:** Публикация, обновление и ASO-оптимизация
...
- **Название:** Чат-бот-лидогенератор
...
- **Название:** Telegram Mini App (магазин внутри мессенджера)
...
### 11. Бот-автоматизатор техподдержки

- **handle:** `bot-helpdesk`
- **Название:** Бот-автоматизатор техподдержки (HelpDesk)
...
### 12. ИИ-ассистент для бизнеса

- **handle:** `ii-assistent-llm-rag`
- **Название:** ИИ-ассистент для бизнеса (LLM + RAG)
...
- **handle:** `bot-buking`
- **Название:** Бот-букинг (запись на услуги)
...
- **Название:** Внедрение CRM (amoCRM, Bitrix24, RetailCRM)
...
### 15. Корпоративный портал

- **handle:** `korporativnyj-portal`
- **Название:** Корпоративный портал (Bitrix24, ELMA365, SimpleOne)
...
- **Название:** Интеграция с 1С и ERP
...
### 17. Интеграция с маркетплейсами

- **handle:** `integracija-marketplejsy`
- **Название:** Интеграция с маркетплейсами (WB, Ozon, Яндекс Маркет)
...
- **Название:** API-шлюзы и middleware
...
- **Название:** Платёжные интеграции и фискализация
...
### 20. Развёртывание серверов

- **handle:** `razvertyvanie-serverov`
- **Название:** Развёртывание и тюнинг выделенных серверов
...
### 22. Масштабирование Highload

- **handle:** `masshtabirovanie-highload`
- **Название:** Масштабирование Highload-систем
...
### 23. Мониторинг и алертинг

- **handle:** `monitoring-alerting`
- **Название:** Мониторинг и алертинг (Observability)
...
- **Название:** Информационная безопасность (DevSecOps и WAF)
...
### 25. QA — ручное тестирование

- **handle:** `qa-ruchnoe-testirovanie`
- **Название:** QA — ручное тестирование и тест-менеджмент
...
- **Название:** Автотестирование (E2E, API, Mobile)
...
- **Название:** Нагрузочное и стресс-тестирование
...
- **Название:** Сквозная бизнес-аналитика
...
### 31. Web Performance Optimization

- **handle:** `web-performance-optimization`
- **Название:** Web Performance Optimization (Core Web Vitals)
...
- **Название:** Code Review и рефакторинг
...
- **Название:** SLA-поддержка IT-инфраструктуры
...
- **Название:** UX/UI аудит и редизайн
...
### 35. Восстановление после взлома

- **handle:** `vosstanovlenie-posle-vzloma`
- **Название:** Восстановление после взлома и очистка сайта
...
- **Название:** HR- и обучающие чат-боты
...
- **Название:** Технический аудит перед разработкой
...
| # | handle | Сгенерировано | Загружено |
|---|--------|:---:|:---:|
| 1 | landing-page-pod-klyuch | ☑ | ☐ |
| 2 | korporativnyj-sajt | ☑ | ☐ |
| 3 | internet-magazin-basic | ☑ | ☐ |
| 4 | ecommerce-enterprise | ☑ | ☐ |
| 5 | veb-prilozhenie-spa-saas | ☑ | ☐ |
| 6 | nativnye-ios-android | ☑ | ☐ |
| 7 | kross-platformennoe-prilozhenie | ☑ | ☐ |
| 8 | publikaciya-aso | ☑ | ☐ |
| 9 | chat-bot-lidogenerator | ☑ | ☐ |
| 10 | telegram-mini-app | ☑ | ☐ |
| 11 | bot-helpdesk | ☑ | ☐ |
| 12 | ii-assistent-llm-rag | ☑ | ☐ |
| 13 | bot-buking | ☑ | ☐ |
| 14 | vnedrenie-crm | ☑ | ☐ |
| 15 | korporativnyj-portal | ☑ | ☐ |
| 16 | integracija-1c-erp | ☑ | ☐ |
| 17 | integracija-marketplejsy | ☑ | ☐ |
| 18 | api-shlyuzy-middleware | ☑ | ☐ |
| 19 | platezhnye-integracii | ☑ | ☐ |
| 20 | razvertyvanie-serverov | ☑ | ☐ |
| 21 | ci-cd-konvejer | ☑ | ☐ |
| 22 | masshtabirovanie-highload | ☑ | ☐ |
| 23 | monitoring-alerting | ☑ | ☐ |
| 24 | informacionnaya-bezopasnost | ☑ | ☐ |
| 25 | qa-ruchnoe-testirovanie | ☑ | ☐ |
| 26 | avtotestirovanie | ☑ | ☐ |
| 27 | nagruzochnoe-testirovanie | ☑ | ☐ |
| 28 | tekhnicheskoe-seo | ☑ | ☐ |
| 29 | skvoznaya-biznes-analitika | ☑ | ☐ |
| 30 | server-side-tracking | ☑ | ☐ |
| 31 | web-performance-optimization | ☑ | ☐ |
| 32 | code-review-refaktoring | ☑ | ☐ |
| 33 | sla-podderzhka | ☑ | ☐ |
| 34 | ux-ui-audit-redizajn | ☑ | ☐ |
| 35 | vosstanovlenie-posle-vzloma | ☑ | ☐ |
| 36 | hr-obuchayushchie-boty | ☑ | ☐ |
| 37 | tekhnicheskij-audit | ☑ | ☐ |
| 38 | cto-as-a-service | ☑ | ☐ |
| 39 | importozameshchenie-po | ☑ | ☐ |
