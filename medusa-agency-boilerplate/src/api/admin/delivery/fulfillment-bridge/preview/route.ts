...
import {
  ...
  sanitizeAdminDeliveryFulfillmentBridgeReadinessPreview,
} from "../../shared"
...
export async function GET(req: AuthenticatedMedusaRequest, res: MedusaResponse) {
  try {
    ...
    const preview = sanitizeAdminDeliveryFulfillmentBridgeReadinessPreview(
      await service.buildFulfillmentBridgeReadinessPreview(data ?? [])
    )
