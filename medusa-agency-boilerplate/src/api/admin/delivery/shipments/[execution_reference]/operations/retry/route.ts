...
import {
  ...
  sanitizeAdminDeliveryAdminShipmentOperationsRetryResponse,
} from "../../../../shared"
...
export async function POST(req: AuthenticatedMedusaRequest, res: MedusaResponse) {
  try {
    ...
    const result = sanitizeAdminDeliveryAdminShipmentOperationsRetryResponse(
      await service.retryAdminShipmentOperationsExecution({
