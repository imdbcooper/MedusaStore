        ...
        >
          ...
          >
            <div className="p-4 flex items-center justify-center">
              <h3 className="text-large-semi">{navigationCopy.cart}</h3>
            </div>
            {cartState && cartState.items?.length ? (
                          ...
                          <div className="flex flex-col flex-1">
                            <div className="flex items-start justify-between">
                              <div className="flex flex-col overflow-ellipsis whitespace-nowrap mr-4 w-[180px]">
                                ...
                                >
                                  {cartCopy.quantity}: {item.quantity}
                                </span>
                              </div>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-ui-fg-base font-semibold">
                      ...
                      <span className="font-normal">
                        ({commonCopy.subtotalExcludingTaxes})
                      </span>
                    </span>
                    <span
              ...
              <div>
                <div className="flex py-16 flex-col gap-y-4 items-center justify-center">
                  ...
                  <span>{cartCopy.emptyDropdown}</span>
                  <div>
                    <LocalizedClientLink href="/store">
                      <>
                        <span className="sr-only">{cartCopy.goToAllProducts}</span>
                        <Button onClick={close}>{cartCopy.exploreProducts}</Button>
                      </>
                    </LocalizedClientLink>
                  </div>
                </div>
